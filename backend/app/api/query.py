...
from app.db.readonly_query import execute_readonly_query
...
def query(request: QueryRequest) -> QueryResponse:
    ...
    try:
        return execute_readonly_query(engine, request.sql, request.limit, request.offset, request.database, request.pg_database)

...
export const DdlPreviewModal = memo(forwardRef<DdlPreviewModalHandle, {
  theme: 'dark' | 'light'
...
export const ImperativeModalHost = memo(forwardRef<ImperativeModalHandle, {
  title: string
  width?: number
  ...
  const resolvedChildren = typeof children === 'function'
    ...
    : contentReady || !deferContentMount
      ? children
      : (
          loadingFallback ?? <div className="deferred-modal-loading"><LoadingOutlined spin /></div>
        )
